...
import com.bennet.wallet.preferences.CardPreferenceManager.readFrontImagePath
import com.bennet.wallet.preferences.CardPreferenceManager.deleteFrontImage
import com.bennet.wallet.preferences.CardPreferenceManager.readBackImagePath
import com.bennet.wallet.preferences.CardPreferenceManager.deleteBackImage
import com.bennet.wallet.preferences.CardPreferenceManager.writeName
import com.bennet.wallet.preferences.CardPreferenceManager.writeCode
import com.bennet.wallet.preferences.CardPreferenceManager.writeCodeType
import com.bennet.wallet.preferences.CardPreferenceManager.writeCodeTypeText
import com.bennet.wallet.preferences.CardPreferenceManager.writeColor
import com.bennet.wallet.preferences.CardPreferenceManager.writePropertyIds
import com.bennet.wallet.preferences.CardPreferenceManager.writePropertyName
import com.bennet.wallet.preferences.CardPreferenceManager.writePropertyValue
import com.bennet.wallet.preferences.CardPreferenceManager.writeFrontImage
import com.bennet.wallet.preferences.CardPreferenceManager.writeBackImage
import com.bennet.wallet.utils.Utility.scaleBitmapToFile
import com.bennet.wallet.utils.Utility.getScaleForMaxSize
...
class CreateExampleCardService : JobIntentService() {
    ...
    companion object {
        ...
        private const val EXTRA_RESULT_RECEIVER =
            "com.bennet.wallet.create_example_card_service.extra_result_receiver"
