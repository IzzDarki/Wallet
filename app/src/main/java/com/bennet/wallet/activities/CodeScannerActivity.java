...
public class CodeScannerActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    static public final String EXTRA_RESULT_CODE_TYPE = "com.bennet.code_scanner.code_type"; // Serializable extra
    static public final String EXTRA_RESULT_CODE = "com.bennet.code_scanner.code"; // String extra
