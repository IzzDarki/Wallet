...
open class CardActivity : AppCompatActivity() {
    ...
    /**
     * This method doesn't seem to change anything (at least on the test device)
    protected fun hideScrollbar() {
    ...
    */
    ...
    companion object {
        // intent extras
        const val EXTRA_CARD_ID = "com.bennet.wallet.cards.extra_card_id"
