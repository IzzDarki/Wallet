...
public class GetImageActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_FILE_PROVIDER_AUTHORITY = "com.bennet.get_image_activity.file_provider_authority";
    public static final String EXTRA_FOLDER_PATH = "com.bennet.get_image_activity.extra_folder_path";
    public static final String EXTRA_FILE_NAME = "com.bennet.get_image_activity.extra_file_name";
    public static final String EXTRA_IMAGE_MAX_NEEDED_SHORT_SIDE = "com.bennet.get_image_activity.extra_image_max_short_side";
    public static final String EXTRA_IMAGE_MAX_NEEDED_LONG_SIDE = "com.bennet.get_image_activity.extra_image_max_long_side";

    public static final String EXTRA_RESULT_URI = "com.bennet.get_image_activity.extra_result_uri";
    public static final String EXTRA_RESULT_FILE = "com.bennet.get_image_activity.extra_result_file";
