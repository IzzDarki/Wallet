...
public class ShowCardActivity extends CardActivity {
    ...
    protected List<CardProperty> cardProperties = new ArrayList<>();

    public static class CardProperty {
        public String name;
        public String value;

        public CardProperty(String name, String value) {
            this.name = name;
            this.value = value;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardPropertiesView.setLayoutManager(layoutManager);
        updateProperties();
        cardPropertiesView.setAdapter(new ShowCardPropertyListItemAdapter(this, cardProperties));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.show_card_action_bar_menu, menu);
        return true;
    }
    ...
    protected void updateProperties() {
        ...
        if (!cardID.equals(""))
            cardProperties.add(new CardProperty(CardPreferenceManager.PREFERENCE_CARD_ID, cardID));
        ...
        for (Integer propertyID : cardPropertyIDs) {
            ...
            cardProperties.add(new CardProperty(name, value));
        }
    }
